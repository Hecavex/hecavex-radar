...
The local HECAVEX Radar package is installed separately with dependency resolution and build isolation disabled. Its direct and build dependencies are therefore supplied by the reviewed lock before the package is built.
